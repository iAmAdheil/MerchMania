  ...
  return (
    <div className="w-full flex flex-col md:flex-row gap-y-6 justify-between items-start md:items-end px-6 md:px-8 lg:px-12 py-6">
      <div>
        ...
        <p className="text-gray-600 text-base font-roboto mt-1">Welcome back, {name}!</p>
      </div>
      <div className="flex flex-row gap-8">
        ...
        <Link
          ...
          className="flex flex-row items-center gap-2 text-xs sm:text-sm font-semibold font-roboto text-white px-5 py-2.5 rounded-lg bg-purple-500 hover:opacity-80"
        >
