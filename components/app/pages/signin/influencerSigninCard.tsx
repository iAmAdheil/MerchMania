...
export default function InfluencerSigninCard() {
	return (
		<div className="w-[25rem] flex flex-col gap-3 border border-solid border-gray-500 px-10 py-6">
			<div className="flex flex-col gap-3">
				<div className="flex flex-col gap-2">
					<h1 className="text-2xl font-roboto font-bold">Creator Login</h1>
					<h2 className="text-xs font-roboto font-light text-gray-300">
						Access your creator dashboard to manage your products
					</h2>
				</div>
				<Button
					colorPalette="teal"
			...
			<div className="flex flex-col gap-4">
				...
				<p className="flex flex-row justify-center items-end gap-1 text-xs font-roboto text-gray-300">
					...
					<a href="" className="text-sm hover:underline">
						<span className="font-semibold text-purple-400">Apply here</span>
					</a>
				</p>
			</div>
		</div>
