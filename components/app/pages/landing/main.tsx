		...
		<div className="flex flex-row w-full">
			<div className="bg-purple-100 flex flex-col gap-8 flex-1 flex-wrap pl-16 pt-28">
				...
				<p className="text-gray-700 text-base font-roboto w-[35rem]">
					Discover unique designs from your favorite influencers. Support creators
					directly and wear merchandise that's as unique as you are.
				</p>
			...
			<div className="bg-purple-100 flex-1"></div>
		</div>
	);
}
