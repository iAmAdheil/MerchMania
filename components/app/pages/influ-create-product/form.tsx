      ...
      <div className="bg-gray-50 w-full py-16 md:py-6 px-6 md:px-10 max-w-5xl mx-auto flex flex-col justify-center items-center gap-8 rounded-lg">
        ...
        <div className="w-full flex flex-col gap-6">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <div
              className={`w-full flex flex-col justify-center items-center border-2 border-dashed rounded-lg p-6 text-center transition-colors duration-200 ${imageDragActive ? 'border-purple-500 bg-purple-50' : 'border-gray-300'
                }`}
