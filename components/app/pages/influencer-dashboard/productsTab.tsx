...
export default function ProductsTab() {
	return (
		<div className="">
			...
			<div>
				<div className='flex flex-col gap-5 pb-6 w-[24rem] bg-white border-[1px] border-solid border-gray-200 rounded-lg'>
					...
					<div className='px-3'>
						<h2 className='text-lg font-semibold font-roboto'>{mockProducts[0].name}</h2>
						<p className='text-sm text-gray-600'>{mockProducts[0].sales} sales • ${mockProducts[0].revenue} revenue</p>
					</div>
					<div className='px-3 flex flex-row gap-4'>
						<button className='flex-1 py-1 text-sm font-semibold border border-solid border-gray-300 rounded-md hover:bg-slate-100'>Edit</button>
						<button className='flex-1 py-1 text-sm font-semibold border border-solid border-gray-300 rounded-md hover:bg-slate-100'>View</button>
					</div>
				</div>
			</div>
		</div>
