...
export default function Navbar() {
    return (
        <div className="bg-white dark:bg-black px-14 py-3 border-b border-solid border-gray-200 dark:border-gray-800 shadow-lg flex flex-row justify-between items-center z-10">
