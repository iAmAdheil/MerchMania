...
export default function RightHero() {
  return (
    <div className="w-full h-full flex flex-col justify-center items-center bg-purple-100">
      <div className="pt-7 pb-10 px-6 md:px-28 lg:px-10 max-w-[50rem] w-full">
        <Marquee
          gradient
          gradientWidth={60}
          ...
          pauseOnHover={true}
          autoFill={true}
          className="mb-3 bg-transparent rounded-lg"
        >
        ...
        <Marquee
          ...
          pauseOnHover={true}
          autoFill={true}
          className="mt-3 bg-transparent rounded-lg"
        >
          <div className="mx-5 flex flex-row gap-10">
            {images.map((image, index) => (
              <img key={index} src={image} alt="Hero Image" className="w-36 h-20 rounded-lg" />
