    ...
    <div className="w-full flex flex-col items-center gap-6">
      <div className="w-full grid grid-cols-2 gap-4 lg:gap-6 lg:grid-cols-4">
        <motion.div
          ...
          className="px-5 py-2 relative flex flex-col gap-3 bg-white border border-solid border-gray-200"
        >
          ...
          <div className="absolute top-0 bottom-0 left-0 right-0 flex justify-center items-center backdrop-blur-[2px] z-10">
